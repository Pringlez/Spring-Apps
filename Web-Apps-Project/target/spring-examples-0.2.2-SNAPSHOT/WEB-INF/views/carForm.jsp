...
<html>
	<head>
		<title>Car Submission Form</title>
	...
	<body>
	    ...
	    <h1 class="pageHeader">Car Form</h1>
		...
		<div class="form formPadding">
			<form method="POST" name="carForm">
				...
				<div class="form-group">
					<label>Mileage</label>
	    			<input name="mileage" class="form-control">
				</div>
				<div class="form-group">
					<label>Year</label>
				...
				<div class="form-group">
	    			...
	    			<input name="engine_size" class="form-control">
				</div>
				<div class="form-group">
					<label>Fuel Type</label>
	    			<input name="fuel_type" class="form-control">
				</div>
				<div class="form-group">
